...
import { RecordingBlockedModal } from '@/components/RecordingBlockedModal';
...
export default function Home() {
  ...
  const { handleRecordingStart, showBlockedModal, setShowBlockedModal } = useRecordingStart(isRecording, setIsRecordingState, showModal);
  const { isParakeetReady, isSummaryReady } = useModelDownload();
  ...
  const showEmptyState = transcripts.length === 0 && !(isParakeetReady && isSummaryReady);
  ...
  return (
    ...
    >
      ...
      {/* Recording Blocked Modal */}
      <RecordingBlockedModal
