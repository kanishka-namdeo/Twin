# GPU-accelerated development script for Twin (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Twin" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Twin in development mode..." -ForegroundColor Blue
Write-Host ""
