...
fn get_ffmpeg_url_for_target(target: &str) -> Result<String, String> {
    ...
    let url = if target.contains("windows") {
        // Windows
        "https://github.com/nathanbabcock/ffmpeg-sidecar/releases/download/v0.1.0/ffmpeg-6.0-essentials_build.zip"
    } else if target.contains("apple") {
        if target.contains("aarch64") {
            // Apple Silicon (M1/M2/M3)
            "https://github.com/nathanbabcock/ffmpeg-sidecar/releases/download/v0.1.0/ffmpeg-6.0-macos-arm64.zip"
        } else {
            // Intel Mac
            "https://github.com/nathanbabcock/ffmpeg-sidecar/releases/download/v0.1.0/ffmpeg-6.0-macos-x64.zip"
        }
    } else if target.contains("linux") {
        if target.contains("aarch64") || target.contains("arm") {
            // Linux ARM64
            "https://github.com/nathanbabcock/ffmpeg-sidecar/releases/download/v0.1.0/ffmpeg-6.0-linux-arm64.tar.xz"
        } else {
            // Linux x86_64
            "https://github.com/nathanbabcock/ffmpeg-sidecar/releases/download/v0.1.0/ffmpeg-6.0-linux-x64.tar.xz"
        }
    } else {
