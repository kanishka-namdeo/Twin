...
When **reviewing recordings** in Twin, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Twin records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Twin recordings** - Use wired/speakers instead
...
### This is Not a Twin Bug

The issue is in **macOS's Bluetooth audio stack**, not in Twin's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Twin bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Twin now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Twin v0.0.5+ on macOS
