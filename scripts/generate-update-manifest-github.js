...
console.log(`GitHub Repository: kanishka-namdeo/Twin`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/kanishka-namdeo/Twin/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/kanishka-namdeo/Twin/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/kanishka-namdeo/Twin/releases/latest/download/latest.json`);
