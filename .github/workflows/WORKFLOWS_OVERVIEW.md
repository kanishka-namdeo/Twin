...
- Artifacts prefixed with `twin-test-`
...
```
twin-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `twin-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `twin-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `twin-macos-aarch64-release-0.1.3`
...
- `TWIN_RSA_PUBLIC_KEY` - License validation public key
